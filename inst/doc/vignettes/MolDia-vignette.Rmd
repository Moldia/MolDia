...
#Introduction
This is a complete package to analyze single cell in-sutu RCA data analysis.
...
###Summary of RCA data
Now we have got the raw RCA data in R. Now we can observed some basic summary statistics about our data which will provide some insight about the data. And based on thses summary we can apply prespective of different analysis.  
...
The ven-pie plot is a visual representaion of RCA data, based on genes of interest. As example, we want to know proportional dependency of SST-interneuronal genes enrich cells. For details about the function see `help(RCA_pieplot)`
